...
const MOCK_ACTIVITIES: Activity[] = [
  ...
  },
  {
    ...
    category: { id: 'c6', name: 'Naturaleza y senderismo', slug: 'naturaleza-senderismo', description: null, icon: '🌿', image_url: null, sort_order: 6, is_active: true, created_at: '' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <p className="text-slate-500">{t('featured_subtitle')}</p>
          </div>
          <Link
            href="/activities"
            className="hidden md:flex items-center gap-1 text-[#0066FF] font-semibold hover:gap-2 transition-all text-sm"
          >
