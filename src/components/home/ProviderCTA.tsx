    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          {/* Provider CTA */}
          <div className="bg-gradient-to-br from-[#0066FF] to-[#0052CC] rounded-3xl p-8 text-white flex flex-col">
            <div className="inline-flex items-center gap-2 bg-white/20 rounded-full px-3 py-1 text-sm font-medium mb-5 self-start">
              Para Proveedores
            </div>
            ...
            <Link href="/auth/register?role=provider">
              <Button variant="white" size="lg" className="font-bold w-full">
                {t('cta_button')} →
              </Button>
            </Link>
          </div>
          ...
          <div className="bg-slate-900 rounded-3xl p-8 text-white flex flex-col">
            <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-3 py-1 text-sm font-medium mb-5 self-start">
              Para Hoteles
            </div>
            ...
            <Link href="/auth/register?role=hotel">
              <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-slate-900 font-bold w-full">
                Registrar mi hotel →
              </Button>
            </Link>
          </div>
