    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-primary to-primary-dark py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-5">Sobre BookActivities</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              BookActivities nació con un objetivo claro: hacer que descubrir y reservar actividades turísticas en Torrevieja sea simple, seguro y satisfactorio para todos.
            </p>
            <p className="text-slate-600 leading-relaxed mb-4">
